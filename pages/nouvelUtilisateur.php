...
<body>
    <div class="container form-shell user-page">
        <div class="form-card">
            <div class="form-card__title">Création d'un nouveau compte utilisateur</div>
                    ...
                    <div class="form-col">
                        <div class="input-container">
                            <input type="text" required="required" minlength="4"
                                ...
                                placeholder="Nom d'utilisateur" autocomplete="off" class="form-control">
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="input-container">
                            <input type="email" required="required" name="email" placeholder="Email professionnel"
                    ...
                    <div class="form-col">
                        <div class="input-container">
                            <input type="password" required="required" minlength="3"
                                ...
                                placeholder="Mot de passe" autocomplete="new-password" class="form-control">
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="input-container">
